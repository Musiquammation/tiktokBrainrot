...
class Game:
	def __init__(self):
		...
		for i in range(5, 25):
			a += .3
			self.arcs.append(Arc(i * SPACING, a, math.pi * (1.5 + .3 * i / 20)))
	...
	def run(self):
		...
		for arc in self.arcs:
			arc.angle += (arc.radius - SPACING) / 30000
			arc.update()
	...
	def draw(self, screen: pygame.Surface):
		...
		pygame.draw.rect(screen, (15, 0, 0), (0, 0, WIDTH, dumb_y))
		pygame.draw.rect(screen, (0, 15, 0), (0, dumb_y, WIDTH, HEIGHT - dumb_y))
		...
		# ====== TITRE PRINCIPAL ======
		title_text = "WILL THE BALL ESCAPE?"
